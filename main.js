...
function draw() {
  ...
  if(status!=""){
    ...
    for ( i = 0; i < object.length; i++) {
      ...
      console.log(object[i].label, document.getElementById("i").value, object[i].label != document.getElementById("i").value);
      if(object[i].label != document.getElementById("i").value)
      {
        setTimeout(()=>{
          song.play();
          console.log("b i n d");
